...
class PublicTree:
    ...
    def build_tree(self):
        ...
        if hasattr(self._env, "reach_probs"):
            ...
            reach_probs = np.full(shape=(self._env_bldr.N_SEATS, self._env_bldr.rules.RANGE_SIZE),
...
class PublicTreeHUNL(PublicTree):
    def __init__(
        ...
        super().__init__(env_bldr, stack_size, stop_at_street, put_out_new_round_after_limit, is_debugging)
